# Veille — candidats du 2026-08-10

27 candidat·s repéré·s sur 24 sources scannées (15 hors fenêtre de fréquence, 39 sources au total) — 26 hors fiches existantes, 15 sur un angle mort ; 0 écarté·s via discovery/ignore.txt. Score pondéré ; à examiner et promouvoir manuellement.

**Pipeline** — 82 leads actifs ; 25 leads touchés cette passe ; 0 pré-fiches générées (Z2 → Z3, seuil 25, 2 indices min).
...
- fondation-de-france-abritees — fréquence trimestrielle
- fondation-du-patrimoine — fréquence trimestrielle
- fnh-fondation — fréquence trimestrielle
- les-scic — fréquence trimestrielle
- conservatoire-littoral — fréquence trimestrielle
- agrasc-biens-affectes — fréquence trimestrielle
- miimosa — fréquence mensuelle
- bluebees — fréquence trimestrielle
...
- **[4]** [Le bilan en carte des 100 jours des maires d’extrême droite - Basta! MenuGoRechercheGoMe connecterPartager l'articleSepaCBApple PayGoogle PayPayPalFermer](https://basta.media/Carte-bilan-villes-RN-100-jours-maires-extreme-droite-attaques-culture-travail-associations) — source : basta — statut : revu — mots-clés : association, commun, ferme
...
- **[3]** [Pour protéger ses habitants des pesticides, une commune de Charente-Maritime rachète des terres agricoles - Basta! MenuGoRechercheGoMe connecterPartager l'articleSepaCBApple PayGoogle PayPayPalFermer](https://basta.media/Pour-proteger-ses-habitants-des-pesticides-commune-LHoumeau-rachete-terres-agricoles-avoisinantes-Charente-Maritime) — source : basta — statut : revu — mots-clés : commun, ferme, terres
