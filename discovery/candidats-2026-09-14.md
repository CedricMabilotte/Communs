# Veille — candidats du 2026-09-14

24 candidat·s repéré·s sur 24 sources scannées (15 hors fenêtre de fréquence, 39 sources au total) — 23 hors fiches existantes, 13 sur un angle mort ; 0 écarté·s via discovery/ignore.txt. Score pondéré ; à examiner et promouvoir manuellement.

**Pipeline** — 85 leads actifs ; 22 leads touchés cette passe ; 0 pré-fiches générées (Z2 → Z3, seuil 25, 2 indices min).
...
- **[3]** [Des associations craignent une privatisation de l’éducation à la sexualité dans les établissements scolaires - Basta! MenuGoRechercheGoMe connecterPartager l'articleSepaCBApple PayGoogle PayPayPal](https://basta.media/on-s-est-fait-rouler-dessus-par-le-prive-dassociations-craignent-privatisation-Evars) — source : basta — statut : nouveau — mots-clés : OFS, association
